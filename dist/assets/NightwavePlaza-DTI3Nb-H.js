import{m as s,d as a,r,j as e,A as P,M as z,c as w,e as c,g as M,h as v}from"./index-B3T7uafB.js";const A="https://radio.plaza.one/mp3",E="https://api.plaza.one/status",D=s`to { transform: perspective(420px) rotateX(74deg) translateY(44px); }`,N=s`to { transform: rotate(360deg); }`,T=s`0%,100% { transform: scaleY(0.18); } 50% { transform: scaleY(1); }`,_=s`0%,100% { opacity: 1; box-shadow: 0 0 7px #ff2d2d; } 50% { opacity: 0.35; box-shadow: 0 0 2px #ff2d2d; }`,I=s`0%,100% { opacity: 0.2; } 50% { opacity: 1; }`,C=s`0% { transform: translateX(0); } 100% { transform: translateX(-50%); }`,R=s`0%,100% { filter: drop-shadow(0 0 24px #ff2d95aa); } 50% { filter: drop-shadow(0 0 40px #ff8a3caa); }`,V=a.div`
    flex: 1;
    min-height: 0;
    position: relative;
    overflow: hidden;
